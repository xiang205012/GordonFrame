...
package com.gean.businessassistant.netstatus;
...
public class NetStateReceiver extends BroadcastReceiver {
    ...
    public final static String CUSTOM_ANDROID_NET_CHANGE_ACTION = "com.gordon.net.conn.CONNECTIVITY_CHANGE";
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (observer != null) {
                    if (isNetworkAvailable()) {
                        observer.netConnected(mNetType);
                    } else {
                        observer.netDisConnect();
                    }
                }
            }
        }
